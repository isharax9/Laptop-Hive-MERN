            ...
            <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
                ...
                <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                    <Stack rowGap={'.4rem'}>
                        ...
                        <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>- Shop
                            Anything</Typography>
                    </Stack>
                ...
                <Stack mt={4} spacing={2} width={is480 ? "95vw" : '28rem'} component={'form'} noValidate
                    ...
                    <MotionConfig whileHover={{y: -5}}>
                        ...
                        <motion.div>
                            <TextField fullWidth {...register("name", {required: "Username is required"})}
                        ...
                        <motion.div>
                            <TextField type='password' fullWidth {...register("password", {
                        ...
                        <motion.div>
                            <TextField type='password' fullWidth {...register("confirmPassword", {
                    ...
                    <motion.div whileHover={{scale: 1.020}} whileTap={{scale: 1}}>
                        <LoadingButton sx={{height: '2.5rem'}} fullWidth loading={status === 'pending'} type='submit'
                                       variant='contained'>Signup</LoadingButton>
                    </motion.div>
                    ...
                    <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}
                        ...
                        <MotionConfig whileHover={{x: 2}} whileTap={{scale: 1.050}}>
                            <motion.div>
                                <Typography mr={'1.5rem'} sx={{textDecoration: "none", color: "text.primary"}}
                                            to={'/forgot-password'} component={Link}>Forgot password</Typography>
                            </motion.div>

                            <motion.div>
                                <Typography sx={{textDecoration: "none", color: "text.primary"}} to={'/login'}
                                            component={Link}>Already a member? <span
