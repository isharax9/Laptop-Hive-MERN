        ...
        <Stack width={'100vw'} height={'100vh'} justifyContent={'center'} alignItems={'center'}>
            ...
            <Stack>
                ...
                <Stack component={Paper} elevation={2}>
                    <Stack component={'form'} width={is500 ? "95vw" : '30rem'} p={'1rem'} rowGap={'1rem'} noValidate
                        ...
                        <Stack rowGap={'.5rem'}>
                            <MotionConfig whileHover={{y: -2}}>
                                ...
                                <motion.div>
                                    <TextField type='password' fullWidth sx={{mt: 1}} {...register("password", {
                                ...
                                <motion.div>
                                    <TextField type='password' fullWidth sx={{mt: 1}} {...register("confirmPassword", {
                                        required: "Please Confirm the password",
                                        validate: (value, formValues) => value === formValues.password || "Passwords dosen't match"
                                    })} placeholder='Confirm New Password'/>
                                    {errors.confirmPassword && <FormHelperText sx={{mt: 1}}
                        ...
                        <motion.div whileHover={{scale: 1.020}} whileTap={{scale: 1}}>
                            <LoadingButton sx={{height: "2.5rem"}} fullWidth loading={status === 'pending'}
                                           type='submit' variant='contained'>Reset Password</LoadingButton>
                        </motion.div>
                    </Stack>
                </Stack>
