...
export const AddProduct = () => {
    ...
    return (
        <Stack p={'0 16px'} justifyContent={'center'} alignItems={'center'} flexDirection={'row'}>
            ...
            <Stack width={is1100 ? "100%" : "60rem"} rowGap={4} mt={is480 ? 4 : 6} mb={6} component={'form'} noValidate
                ...
                <Stack rowGap={3}>
                    ...
                    <Stack flexDirection={'row'}>
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select {...register("brand", {required: "Brand is required"})} labelId="brand-selection"
                                    label="Brand">
                    ...
                    <Stack flexDirection={'row'}>
                        ...
                        <Stack flex={1}>
                            ...
                            <TextField
                                type='number' {...register("discountPercentage", {required: "discount percentage is required"})}/>
                        </Stack>
                    </Stack>
