    ...
    return (
        <Stack p={'0 16px'} justifyContent={'center'} alignItems={'center'} flexDirection={'row'}>

            {
                ...
                <Stack width={is1100 ? "100%" : "60rem"} rowGap={4} mt={is480 ? 4 : 6} mb={6} component={'form'}
                       noValidate onSubmit={handleSubmit(handleProductUpdate)}>
                    ...
                    <Stack rowGap={3}>
                        ...
                        <Stack flexDirection={'row'}>
                            ...
                            <FormControl fullWidth>
                                ...
                                <Select
                                    defaultValue={selectedProduct.brand._id} {...register("brand", {required: "Brand is required"})}
                                    labelId="brand-selection" label="Brand">
                                    {
                                        brands.map((brand) => (
                            ...
                            <FormControl fullWidth>
                                ...
                                <Select
                                    defaultValue={selectedProduct.category._id} {...register("category", {required: "category is required"})}
                        ...
                        <Stack flexDirection={'row'}>
                            ...
                            <Stack flex={1}>
                                <Typography variant='h6' fontWeight={400}
                                            gutterBottom>Discount {is480 ? "%" : "Percentage"}</Typography>
                        ...
                        <Stack>
                            ...
                            <TextField type='number' {...register("stockQuantity", {
                            ...
                            <Stack rowGap={2}>
                                {
                                    selectedProduct.images.map((image, index) => (
                                        <TextField {...register(`image${index}`, {
                    ...
                    <Stack flexDirection={'row'} alignSelf={'flex-end'} columnGap={is480 ? 1 : 2}>
                        ...
                        <Button size={is480 ? 'medium' : 'large'} variant='outlined' color='error' component={Link}
                                to={'/admin/dashboard'}>Cancel</Button>
                    </Stack>
