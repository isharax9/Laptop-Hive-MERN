    ...
    return (
        <Stack justifyContent={'center'} alignItems={'center'}>
            ...
            <Stack mt={5} mb={3} component={'form'} noValidate onSubmit={handleSubmit(handleUpdateOrder)}>
                ...
                {
                    orders.length ?
                        <TableContainer sx={{width: is1620 ? "95vw" : "auto", overflowX: 'auto'}} component={Paper}
                                        elevation={2}>
...

                                    {
                                        orders.length && orders.map((order, index) => (
                                            ...
                                            <TableRow key={order._id}
                                                ...
                                                <TableCell
                                                    align="right">{new Date(order.createdAt).toDateString()}</TableCell>
...

                                                    {
                                                        editIndex === index ? (
                                                            ...
                                                            <FormControl fullWidth>
                                                                <InputLabel id="demo-simple-select-label">Update
                                                                    status</InputLabel>
                                                                <Select
...

                                                    {
                                                        editIndex === index ? (
                                                                <Button>
                                                                    ...
                                                                    <IconButton
                                                                        type='submit'><CheckCircleOutlinedIcon/></IconButton>
                                                                </Button>
                                                            )
                                                            :
                                                            <IconButton
                                                                onClick={() => setEditIndex(index)}><EditOutlinedIcon/></IconButton>
                                                    }
                        ...
                        <Stack width={is480 ? "auto" : '30rem'} justifyContent={'center'}>
                            ...
                            <Stack rowGap={'1rem'}>
                                ...
                                <Typography textAlign={'center'} alignSelf={'center'} variant='h6' fontWeight={400}>There
                                    are no orders currently</Typography>
                            </Stack>
