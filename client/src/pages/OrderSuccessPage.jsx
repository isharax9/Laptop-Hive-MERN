...
export const OrderSuccessPage = () => {
    ...
    return (
        <Stack width={'100vw'} height={'100vh'} justifyContent={'center'} alignItems={'center'}>
            ...
            <Stack component={Paper} boxShadow={is480 ? 'none' : ""} rowGap={3} elevation={1} p={is480 ? 1 : 4}
                ...
                <Button component={Link} to={'/orders'} onClick={() => dispatch(resetCurrentOrder())}
                        size={is480 ? "small" : ""} variant='contained'>Check order status in my orders</Button>
            </Stack>
